...
AI_ALIGNED(32)
static uint8_t pool0[AI_BILSTM_MODEL_DATA_ACTIVATION_1_SIZE];
...
static const ai_network_entry_t networks[AI_MNETWORK_NUMBER] = {
    {
        .name = (const char *)AI_BILSTM_MODEL_MODEL_NAME,
        .config = AI_BILSTM_MODEL_DATA_CONFIG,
        .ai_get_report = ai_bilstm_model_get_report,
        .ai_create = ai_bilstm_model_create,
        .ai_destroy = ai_bilstm_model_destroy,
        .ai_get_error = ai_bilstm_model_get_error,
        .ai_init = ai_bilstm_model_init,
        .ai_run = ai_bilstm_model_run,
        .ai_forward = ai_bilstm_model_forward,
        .ai_data_params_get = ai_bilstm_model_data_params_get,
