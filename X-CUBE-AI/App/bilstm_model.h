...
#ifndef AI_BILSTM_MODEL_H
#define AI_BILSTM_MODEL_H
#pragma once

#include "bilstm_model_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_BILSTM_MODEL_MODEL_NAME          "bilstm_model"
#define AI_BILSTM_MODEL_ORIGIN_MODEL_NAME   "my_model"

/******************************************************************************/
#define AI_BILSTM_MODEL_ACTIVATIONS_ALIGNMENT   (4)
#define AI_BILSTM_MODEL_INPUTS_IN_ACTIVATIONS   (4)
#define AI_BILSTM_MODEL_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_BILSTM_MODEL_IN_NUM        (1)

AI_DEPRECATED
#define AI_BILSTM_MODEL_IN \
  ai_bilstm_model_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_BILSTM_MODEL_IN_SIZE { \
  AI_BILSTM_MODEL_IN_1_SIZE, \
}
#define AI_BILSTM_MODEL_IN_SIZE_BYTES { \
  AI_BILSTM_MODEL_IN_1_SIZE_BYTES, \
}
#define AI_BILSTM_MODEL_IN_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_BILSTM_MODEL_IN_1_HEIGHT      (1)
#define AI_BILSTM_MODEL_IN_1_CHANNEL     (4096)
#define AI_BILSTM_MODEL_IN_1_SIZE        (1 * 4096)
#define AI_BILSTM_MODEL_IN_1_SIZE_BYTES  (16384)

/******************************************************************************/
#define AI_BILSTM_MODEL_OUT_NUM       (1)

AI_DEPRECATED
#define AI_BILSTM_MODEL_OUT \
  ai_bilstm_model_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_BILSTM_MODEL_OUT_SIZE { \
  AI_BILSTM_MODEL_OUT_1_SIZE, \
}
#define AI_BILSTM_MODEL_OUT_SIZE_BYTES { \
  AI_BILSTM_MODEL_OUT_1_SIZE_BYTES, \
}
#define AI_BILSTM_MODEL_OUT_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_BILSTM_MODEL_OUT_1_CHANNEL     (9)
#define AI_BILSTM_MODEL_OUT_1_SIZE        (9)
#define AI_BILSTM_MODEL_OUT_1_SIZE_BYTES  (36)

/******************************************************************************/
#define AI_BILSTM_MODEL_N_NODES (11)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup bilstm_model
 ...
 * @ref ai_bilstm_model_create. Both the activations memory buffer 
 ...
 * using @ref ai_bilstm_model_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_bilstm_model_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_bilstm_model_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_BILSTM_MODEL_*
 * defines into file @ref bilstm_model.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_bilstm_model_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_BILSTM_MODEL_H */
